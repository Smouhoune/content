...
DEFAULT_AIDE_DB_PATH = '/var/lib/aide/aide.db.gz'
DEFAULT_AIDE_DB_NEW_PATH = '/var/lib/aide/aide.db.new.gz'
DEFAULT_AIDE_DB_PATH_UNCOMPRESSED = '/var/lib/aide/aide.db'
DEFAULT_AIDE_DB_NEW_PATH_UNCOMPRESSED = '/var/lib/aide/aide.db.new'
